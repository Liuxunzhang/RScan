...
pub(crate) fn scan_cassandra(target: &OpenService, context: &PluginContext) -> Result<Option<PluginFinding>> {
...
pub(crate) fn cassandra_startup_frame() -> Vec<u8> {
...
pub(crate) fn cassandra_auth_response_frame(username: &str, password: &str) -> Vec<u8> {
...
pub(crate) fn cassandra_string(value: &str) -> Vec<u8> {
